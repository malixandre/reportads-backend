...
let PdfService = PdfService_1 = class PdfService {
    ...
    fmtDate(d) { return new Date(d).toLocaleDateString('pt-BR'); }
    fmtNum(n) {
    ...
    buildHeader(campaign, accentColor) {
    ...
    buildDayPages(metrics, printsByDate, campaign, accentColor) {
